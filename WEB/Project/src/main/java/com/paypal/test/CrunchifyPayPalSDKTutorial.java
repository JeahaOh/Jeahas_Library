...
public class CrunchifyPayPalSDKTutorial {
    private static String crunchifyID = "AeSg7nrPgOnaLeC1Zbcl7pWQr9XMuFUdUk8D99gUZKOb28daG9uodmEUYjAvFYkG1vbyByauGFZM3Exa";  //  "<!---- Add your clientID Key here ---->";
    private static String crunchifySecret = "EErQ4jTMEZxK6WOPdGgOj01dGhl0XFQMqRFhv4av2Bkk_bE0rKKA7i0CLI4o83_BvRVUHHMD8u8Oobos"; //  "<!---- Add your clientSecret Key here ---->";
    ...
    public void crunchifyCapturePayPalAPI() {
        ...
        crunchifyTransaction.setDescription("How To Invoke");        //  <!---- "Crunchify Tutorial: How to Invoke PayPal REST API using Java Client?" ---->
        ...
        try {
            ...
            crunchifyPaymentExecution.setPayerId("sorrowkissed-buyer@naver.com");   //  <!---- Add your PayerID here ---->
            ...
            log("sorrowkissed-facilitator@naver.com" + crunchifyAuthorization.getId());  //  <!---- Here is your Authorization ID ---->
